...
Test MCP servers with declarative YAML scenarios - generated by the [mcpcontract CLI](https://github.com/cisco-open/mcptoolkit-contract).
...
> **⚠️ Pre-release notice**: mcptest is functional but has seen limited real-world testing compared to other MCP Toolkit tools. Core workflows (generate, run, record) have been validated against the chess-coach example server; broader compatibility and edge cases are still being hardened. Feedback and bug reports are welcome.
